...
class WalkingStrategy extends NavigatorContext implements Strategy {
    findRoute(A: SimpleLocation, B: SimpleLocation) {
...
const GasStation: SimpleLocation = {
    latitude: 47.101563,
    longitude: 25.410596
};

const NationalPark: SimpleLocation = {
    latitude: 47.101504,
    longitude: 25.399015
};
let result = navigatorContext.findRoute(GasStation, NationalPark);
console.log(result);
